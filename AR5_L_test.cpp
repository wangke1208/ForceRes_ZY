...
int main() {
    ...
    // 6.设置力控软限位
    PDO_0x6061 = {8, 8, 8, 8, 8, 8, 8};
    std::vector<double> soft_limit_low = {-178.0, -120.0, -178.0, -60.0, -178.0, -110.0, -180.0};
    std::vector<double> soft_limit_high = {178.0, 120.0, 178.0, 145.0, 178.0, 110.0, 180.0};
    ...
    // ----------------------接口测试--------------------------------------
    // 1.逆解接口
    std::array<double, 16U> CartPos = {0.225478866721534,
                                       -0.851011404533511,
                                       0.474277207986926,
                                       0.0203068596993031,
                                       0.16523513002721,
                                       ...
                                       0,
                                       1};
    double psi = 2.87554289000137;
    std::vector<double> q_init = {2.2706, 0.4715, 3.0442, 0.8408, -0.1272, 1.1571, 2.8632};
    std::vector<double> q_out;
    q_out.resize(7);
    RokaeForce_GetJointPos(CartPos, psi, q_init, q_out);
    SPD_CONTAINER("逆解结果为: ", q_out);
    ...
    res = RokaeForce_DragConfig(PDO_0x6064, PDO_0x6061, PDO_0x2401, PDO_0x2402, drag_type, false);
    if (res != 0) {
    ...
    while (time < continue_time) {
        ...
        res = RokaeForce_FcUpdate(PDO_0x6061, PDO_0x2401, PDO_0x2402, PDO_0x2406, PDO_0x6064, PDO_0x606C, jnt_pos_cmd_zero,
                                  cart_pos_cmd, jnt_pos_cmd_zero, PDO_0x6071, PDO_0x60B2, PDO_0x2201, PDO_0x2202, PDO_0x2203,
