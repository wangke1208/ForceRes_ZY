...
#ifndef ROKAE_HEADER_ROKAE_IK_SOLVER_INVERSE_KINEMATICS_SOLVER_H
#define ROKAE_HEADER_ROKAE_IK_SOLVER_INVERSE_KINEMATICS_SOLVER_H
...
class inverse_kinematics_solver: public IKSolverBase {
   public:
    inverse_kinematics_solver(const KDL::Chain& chain, const ModelParams& model_param);

    ~inverse_kinematics_solver() override = default;
