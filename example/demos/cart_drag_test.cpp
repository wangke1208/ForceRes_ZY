...
int main() {
    ...
    std::array<double, 6> base_frame = {0,0,0,90,0,0};
    ...
    // 6.设置力控软限位
    PDO_0x6061 = {8, 8, 8, 8, 8, 8, 8};
    std::vector<double> soft_limit_low = {-178, -120, -178, -60, -178, -110, -180};
    ...
    External_DragType drag_type = External_DragType::DRAG_CART_TRANS;
